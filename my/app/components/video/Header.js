  ...
  return (
    <header className="flex flex-wrap items-center justify-between bg-gray-800 px-4 sm:px-6 py-2 sm:py-3 border-b border-gray-700 shadow-md">
      ...
      <div className="flex items-center space-x-2 sm:space-x-4 mt-2 sm:mt-0">
        ...
        <button
          aria-label="Record"
          className="flex items-center gap-1 sm:gap-2 bg-red-700 hover:bg-red-600 px-2 sm:px-3 py-0.5 sm:py-1 rounded text-white text-[10px] sm:text-sm font-semibold transition"
        >
        ...
        <button
          ...
          className="bg-red-600 hover:bg-red-700 rounded px-2 sm:px-4 py-0.5 sm:py-1 text-white font-semibold text-[10px] sm:text-sm shadow-md transition"
        >
          End
        </button>
      </div>
