    ...
    <>
      <div className="flex flex-wrap max-w-5xl justify-center gap-6 mb-14">
        ...
        <div
          ...
          className="cursor-pointer bg-gray-800 border border-gray-700 rounded-xl 
                     w-40 sm:w-48 md:w-56 lg:w-64 min-h-[110px] sm:min-h-[140px] p-4 
                     flex flex-col gap-2 hover:border-green-500 transition-all"
        >
