...
import VoiceInterview from '@/app/interview/page';
...
// // import { useAppContext } from '../context/AppContext';
// // import { uploadResume } from '@/components/interview/DataResume.js';
// // import { filterResumeData } from '@/components/interview/ResumeFilter.js';

// // export default function ResumeModal({ isOpen, onClose }) {
// //   const { setResumeData } = useAppContext();
// //   const [resumeFile, setResumeFile] = useState(null);
// //   const [role, setRole] = useState('');
// //   const [VoiceInterviewType, setVoiceInterviewType] = useState('');
// //   const [duration, setDuration] = useState('10');
// //   const [termsAccepted, setTermsAccepted] = useState(false);
// //   const [isFormValid, setIsFormValid] = useState(false);
// //   const [loading, setLoading] = useState(false);
...
// //         const filtered = filterResumeData(data, role, VoiceInterviewType);

// //         localStorage.setItem("VoiceInterviewData", JSON.stringify({
// //           questions: filtered.questions,
// //           resumeSummary: filtered.cleanText,
// //           VoiceInterviewType,
// //           duration
...
// //         // Navigate to the VoiceInterview page
...
// //       termsAccepted
// //     );
// //   }, [role, VoiceInterviewType, duration, resumeFile, termsAccepted]);
...
// //         <h2 className="text-2xl sm:text-3xl font-bold mb-3">Resume Based VoiceInterview</h2>
// //         <p className="text-sm sm:text-base text-gray-400 mb-5">Upload your resume in PDF format</p>
...
// //             <select
// //               className="flex-1 p-3 bg-gray-800 border border-gray-700 rounded text-sm sm:text-base"
// //               value={VoiceInterviewType}
// //               onChange={(e) => setVoiceInterviewType(e.target.value)}
// //               required
// //             >
// //               <option value="">Select</option>
// //               <option value="Technical">Technical</option>
...
// //           <div className="text-sm sm:text-base text-gray-400">VoiceInterview Duration *</div>
// //           <div className="flex flex-wrap gap-4 text-sm sm:text-base">
// //             {['10', '20', '30'].map((value) => (
// //               <label key={value} className="flex items-center gap-2">
// //                 <input
...
// //             disabled={!isFormValid || loading}
// //           >
// //             {loading ? 'Uploading...' : 'Start VoiceInterview'}
// //           </button>
// //         </form>
// //       </div>
// //     </div>
