...
//   const {user, setResumeData, setQuestions, setResumeSummary, setInterviewType } = useAppContext();
...
//         // stop tracks immediately (no need to keep camera on here)
