...
# # HR questions list with placeholder {}
...
#     # Use up to 10 HR questions (random selection)
#     hr_qs = [q.format(k) for k in all_keywords[10:20] for q in random.sample(HR_QUESTION_TEMPLATE, 5)]
